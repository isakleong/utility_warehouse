...
class AdjustmentStockOpname extends StatefulWidget {

  const AdjustmentStockOpname({Key key}) : super(key: key);

  @override
  AdjustmentStockOpnameState createState() => AdjustmentStockOpnameState();
}

class AdjustmentStockOpnameState extends State<AdjustmentStockOpname> {
